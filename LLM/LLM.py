...
def generate_ad_with_context(input_str, emotion, tone='Natural'):
    ...
    thoughts = [
        ...
        "You must abide by the following rules:Output shall consist solely of the final advertisement text generated by the model. Only the advertisement is to be printed once; no additional information or context is required."
    ]
