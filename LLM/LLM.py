...
class AdvertisementGenerator:
    ...
    GENERATION_PARAMS = {
"max_new_tokens": 120, # The maximum number of tokens generated, controlling the length of the output text. Setting it to 120 means generating up to 120 tokens.
...
"num_beams": 4, # The number of beams for beam search. The larger the value, the higher the quality of the generated text may be, but the computational cost is also higher. Setting it to 4 means using 4 beams for search.
"length_penalty": 1.0, # Controls the penalty factor for the length of the generated text. Values ​​greater than 1.0 encourage the generation of long text, and values ​​less than 1.0 encourage the generation of short text. 1.0 means no additional penalty is imposed.
