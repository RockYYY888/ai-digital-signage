...
def process_frame_for_face_attributes(initial_frame):
    ...
    for result in results:
        ...
        age_label, gender_label, race_label = predict_face_attributes(model_demographic, pil_image)
        ...
        for new_result in new_results:
            ...
            # 
            prediction = predict_face_attributes(model_demographic, new_pil_image)

            # 调用情绪预测函数
            prediction2 = predict_emotion(model_emotion, new_pil_image)
